...
#define EVENT_CHECK_HEADER "check_beacon_events.h"

// Comma separated list of event checking functions
#define EVENT_CHECK_LIST check_beacon_events

// These are the definitions for the post functions to be executed when the
// corresponding timer expires. All 16 must be defined. If you are not using
// a timers, then you can use TIMER_UNUSED
#define TIMER_UNUSED ((pPostFunc)0)
#define TIMER0_RESP_FUNC post_scanning_service
#define TIMER1_RESP_FUNC post_scanning_service
...
#define GUN_ROTATE_TIMER 0
#define GUN_ROTATE_TIMER_TIME 5000 // 5 seconds

#define GUN_PITCH_TIMER 1
#define GUN_PITCH_TIMER_TIME 500 // 0.5 seconds
...
#if NUM_SERVICES > 1
#define SERV_1_HEADER "scanning_service.h"
#define SERV_1_INIT init_scanning_service
#define SERV_1_RUN run_scanning_service
